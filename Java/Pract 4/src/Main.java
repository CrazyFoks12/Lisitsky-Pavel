// . Реализация готовой продукции. Создать родительский класс "товар"(идентификатор,код,наименование,Цена, описание)
// и дочерние классы: - хрупкий товар (коэффициент хрупкости); - скоропортящийся товар (мах время хранения);
